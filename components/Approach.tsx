...
const Approach = ()  => {
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 m">
        <Card 
        title="Planning And Strategy"
        icon={<AceternityIcon
        order='Phase 1' />}
        description="We'll collaborate to map out 
        your website's goals,target audience and key
        functionalities.We'll discuss things like site
        ...
        I dive straight into coding.From initial sketches
        to polished pseudo code,I keep you updated every step 
        of the way. ">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
         title="Development And Launch"
          ...
          Based on our approved design,I'll translate everything into functional code,building your web or mobile app from ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
